...
def getSymbols():
    urlSym = "https://forex.1forge.com/1.0.3/symbols?api_key="
    return loadReadUrl(urlSym)

def getFxPairs(fxPairs):
    urlFxPairs = "https://forex.1forge.com/1.0.3/quotes?pairs="+ fxPairs +"&api_key="
    return loadReadUrl(urlFxPairs)

def marketStatus():
    urlMktStatus = "https://forex.1forge.com/1.0.3/market_status?api_key="
    return loadReadUrl(urlMktStatus)

def getForgeQuota():
    urlQuota = "https://forex.1forge.com/1.0.3/quota?api_key="
